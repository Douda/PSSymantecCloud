...
# $json_empty_structure = Get-Content "C:\Users\aurel\OneDrive\Documents\Projects\PSSymantecCloud\Data\empty_structure.json" -Raw | ConvertFrom-Json
# $json_empty_structure | Optimize-SepCloudAllowListPolicyObject

$json_1_add_1_remove = Get-Content "C:\Users\aurel\OneDrive\Documents\Projects\PSSymantecCloud\Data\allowlist_structure_1_add_1_remove.json" -Raw | ConvertFrom-Json
$json_1_add_1_remove | Optimize-SepCloudAllowListPolicyObject | ConvertTo-Json -Depth 100


# $json_easy_one_empty = Get-Content "C:\Users\aurel\OneDrive\Documents\Projects\PSSymantecCloud\Data\empty_structure_easy.json" -Raw
# $final = $json_easy_one_empty | ConvertFrom-Json | Optimize-SepCloudAllowListPolicyObject
# $final


# $json_merged = Get-Content "C:\Users\aurel\OneDrive\Documents\Projects\PSSymantecCloud\Data\PSObjects\obj_merged_policy_before_json_conversion.json" -Raw | ConvertFrom-Json
# $json_merged | ConvertFrom-Json | Optimize-SepCloudAllowListPolicyObject
